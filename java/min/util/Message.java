...
public class Message {
    ...
    public static final String IMG_PATH = "http://127.0.0.1:8888/BookMS/upload/bookPhoto";//?
    public static final String IMG_LOCAL_PATH = "upload/bookPhoto/";
    public static final String LOGIN_FAILED_MSG = "Fail login！";
    public  static final String FIRST_NAME = "陈林周张李黄王吴刘蔡杨许"
            + "郑谢郭洪邱曾廖赖徐周叶苏庄江"
            + "吕何罗高萧潘朱简钟彭游詹胡施"
            + "沉余赵卢梁颜柯孙魏翁戴范宋方"
            + "邓杜傅侯曹温薛丁马蒋唐卓蓝冯"
            ...
            + "白涂尤巫韩龚严袁钟黎金阮陆倪"
            + "夏童邵柳钱";
    public static final String COMMON_CHARACTERS ="得经十三之进着等部度家电力里如水化高自" +
